    ...
    <div className="min-h-screen flex items-center justify-center px-6 pt-28 pb-12">
      ...
      >
        <div className="text-center mb-10">
          <h1 className="font-display text-4xl sm:text-5xl font-bold mb-3 text-text">Welcome Back</h1>
          <p className="text-text-muted text-lg">Log in to access your recipes</p>
        </div>
